...
import 'file:///C:/AndroidStudio/fluttre_project/tatweer/lib/screen/locatoin.dart';
import 'package:tatweer/services/get_store_info.dart';
          ...
          appBar: AppBar(
            ...
            actions: [
              IconButton(
                ...
                onPressed: () {
                  Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => Location( Accesss_Token :widget.Accesss_Token , Token_type :widget.Accesss_Token)));
